...
description: >-
  ...
  the BankCEX Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the BankCEX network on your Metamask wallet before creating the community. Learn how to add BankCEX network to Metamask using [this](https://docs.bankcexchain.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) tutorial.
...
You can also view both your ETH balance and BANK balance by clicking on “BankCEX network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on BankCEX”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to BankCEX network.
